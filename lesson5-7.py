...
try:
    with open("text5-7.txt") as my_file:      # Открытие файла для чтения
        sss = my_file.readlines()    # Сериализация файла, для преобразования в словарь
        print(sss)
